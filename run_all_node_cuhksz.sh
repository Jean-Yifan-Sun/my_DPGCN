...
/mnt/ssd1/sunyifan/conda/mygcn/bin/python /mnt/ssd1/sunyifan/WorkStation/dpuf/my_DPGCN/newmain.py --early_stopping no --weight_decay 0 --learning_rate 5e-4 --shadow_learning_rate 0.001 --dropout 0  --epochs 500 --shadow_epochs 500 --mia_subsample_rate 0.5 --dataset lastfmasia --device_num 0 --private yes --noise_scale 10 --split_n_subgraphs 1 --rdp true --optim_type adam --gradient_norm_bound 2 --sampler occurance --sampler_batchsize .7 --occurance_k 10 --cluster_numparts 100 --saint_numsteps 5 --saint_samplecoverage 50 --saint_walklenth 3 --shadowk_depth 2 --shadowk_neighbors 10 --shadowk_replace false

/mnt/ssd1/sunyifan/conda/mygcn/bin/python /mnt/ssd1/sunyifan/WorkStation/dpuf/my_DPGCN/newmain.py --early_stopping no --weight_decay 0 --learning_rate 5e-3 --shadow_learning_rate 0.001 --dropout 0  --epochs 500 --shadow_epochs 500 --mia_subsample_rate 0.5 --dataset lastfmasia --device_num 0 --private yes --noise_scale 1 --split_n_subgraphs 1 --rdp true --optim_type adam --gradient_norm_bound 2 --sampler neighbor --sampler_batchsize .2 --occurance_k 10 --cluster_numparts 30 --saint_numsteps 5 --saint_samplecoverage 50 --saint_walklenth 3 --shadowk_depth 2 --shadowk_neighbors 10 --shadowk_replace false
